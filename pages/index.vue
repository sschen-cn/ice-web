...
.container
  .house(ref='house')
    .items(v-for='(item, index) in houses' :key='index' @click='showHouse(item)')
      .desc
        ...
        .name {{item.cname}}
      .house-flag
        img(:src='imageCDN + item.cname + ".JPEG"')
  ...
  .city
    .city-title 维斯特洛
    .city-intro 在征服战争统一维斯特洛之前，维斯特洛被划分为许多独立的王国。在伊耿征服之后，坦格利安王朝将所谓七大王国合并，把维斯特洛划分为四个主要区域——北境，南境，东境，西境，任命当地的一位封臣为每个区域的守护和管理者。在本书的开篇，兰尼斯特家族为西境守护，史塔克家族为北境守护，提利尔家族为南境守护，艾林家族为东境守护。大陆基本被分为九个区域
