...
// pdyll2ba5.bkt.clouddn.com
export const getWikiCharacters = async () => {
  let data = require(resolve(__dirname, '../database/fullCharacters.json'))
  ...
  writeFileSync(resolve(__dirname, '../database/json/finalCharacters.json'), JSON.stringify(data, null, 2), 'utf8')
}

export const fetchImageFromIMDb = async () => {
  let IMDbCharacters = require(resolve(__dirname, '../database/finalCharacters.json'))
  ...
  writeFileSync(resolve(__dirname, '../database/json/completeCharacters.json'), JSON.stringify(IMDbCharacters, null, 2), 'utf8')
}

// http://pdyplk1dz.bkt.clouddn.com/nm3729225/bvfpc56lone6fkz88hoywwp7w5x31t53
...
export const getHouses = async () => {
  ...
  writeFileSync(resolve(__dirname, '../database/json/wikiHouses.json'), JSON.stringify(data, null, 2), 'utf8')
}

export const getSwornMembers = () => {
  let houses = require(resolve(__dirname, '../database/wikiHouses.json'))
  let characters = require(resolve(__dirname, '../database/completeCharacters.json'))
